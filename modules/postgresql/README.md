...
| secondary\_zone | The secondary zone for the master instance. Used for high availability fallbacks, it should be something like: `us-central1-a`, `us-east1-c`. | `string` | `null` | no |
